...
namespace DiveCRM.Web.DAL.Base
{
    public interface IBaseRepository<T>
    {
        ...
        PagedList<T> FindPageList1<S>(int pageIndex, int pageSize, out int totalRecord, Expression<Func<T, bool>> whereLamdba, bool isAsc, Expression<Func<T, S>> orderLamdba);

        List<T> FindListBySQL<S>(string sql, params object[] parameters);
