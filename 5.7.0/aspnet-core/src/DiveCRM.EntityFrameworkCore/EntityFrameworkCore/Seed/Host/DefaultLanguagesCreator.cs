...
namespace DiveCRM.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly DiveCRMDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = DiveCRMConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(DiveCRMDbContext context)
        {
            _context = context;
        }
