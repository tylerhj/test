...
{
    public abstract class DiveCRMWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DiveCRMWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DiveCRMWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DiveCRMDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DiveCRMDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DiveCRMDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DiveCRMDbContext, Task<T>> func)
        {
            T result;
